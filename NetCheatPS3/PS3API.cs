...
namespace PS3Lib
{
 ...
 //           byte[] buffer1 = {00000000,00000000,00000000,00000000};
 //               Common.CcApi.GetMemory(offset, buffer1);
 // Verify checks out, ram appears to be written to.... addresses are all wrong?
        }
        ...
        public class ConsoleList
        {
            ...
            public bool Show()
            {
                ...
                //imgL.Images.Add(NetCheatPS3.Properties.Resources.ResourceManager.GetObject(PS3API));
